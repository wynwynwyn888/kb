...
import { InboundAutoTaggingService } from './inbound-auto-tagging.service';
...
@Module({
  ...
  providers: [TagRulesService, TagRuleMatchService, InboundAutoTaggingService],
  exports: [TagRulesService, TagRuleMatchService, InboundAutoTaggingService],
})
