...
`,
      ...
      {testModalOpen ? (
        ...
        >
          <div style={{ ...modalPanel, maxWidth: 1000, width: 'calc(100vw - 2rem)', height: '92vh', maxHeight: '92vh', display: 'flex', flexDirection: 'column' }} role="dialog" aria-modal="true" onClick={e => e.stopPropagation()}>
            <div style={{ padding: '0.75rem 1.15rem', borderBottom: '1px solid var(--aisbp-modal-divider, #f1f5f9)', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexShrink: 0, gap: '0.75rem' }}>
              <div>
                <h2 style={{ fontSize: '1.05rem', fontWeight: 800, margin: 0, color: 'var(--aisbp-text-heading, #0f172a)' }}>
                  Test AI
                </h2>
            ...
            <div style={{ padding: '0.5rem 0.75rem', flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column' }}>
              {token && subaccountId ? (
