  ...
  return (
    <>
      <SectionCard
        ...
        subtitle="Handover behavior currently applies across this workspace and conversation state."
        accent="muted"
      >
        <p style={{ fontSize: '0.9rem', color: 'var(--aisbp-text-secondary)', lineHeight: 1.55, margin: 0 }}>
          Profile-specific handover rules are planned for a future release.
        </p>
      </SectionCard>
